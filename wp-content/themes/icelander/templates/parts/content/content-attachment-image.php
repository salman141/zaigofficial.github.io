...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		...
		<table>
			...
			<caption><?php echo esc_html_x( 'Image info', 'Attachment page image info table caption.', 'icelander' ); ?></caption>

			<tbody>

				<tr class="date">
					<th><?php echo esc_html_x( 'Image published on:', 'Attachment page publish time.', 'icelander' ); ?></th>
				...
				<tr class="size">
					<th><?php esc_html_e( 'Image size:', 'icelander' ); ?></th>
				...
				<tr class="filename">
					<th><?php esc_html_e( 'Image file name:', 'icelander' ); ?></th>
