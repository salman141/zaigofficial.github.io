...
// Helper variables
	...
	$child_id      = get_the_ID();
	$has_more_link = (bool) apply_filters( 'wmhook_icelander_content_child_page_has_more_link', get_the_content(), $child_id );
	$image_size    = (string) apply_filters( 'wmhook_icelander_content_child_page_image_size', 'medium', $child_id );
	...
	// Getting a (custom) featured image
		...
		$page_image_url = (string) apply_filters( 'wmhook_icelander_content_child_page_image_url', $page_image_url, $child_id );
