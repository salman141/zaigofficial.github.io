 ...
 * @version  1.5.0
 */
class Icelander_Customize_Control_Radio_Matrix extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		// Processing
			...
			// Scripts
				...
				wp_enqueue_script(
						'icelander-customize-control-radio-matrix',
						get_theme_file_uri( ICELANDER_LIBRARY_DIR . 'js/customize-control-radio-matrix.js' ),
...
} // /Icelander_Customize_Control_Radio_Matrix
