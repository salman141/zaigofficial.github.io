 ...
 * @version  1.5.0
 */
class Icelander_Customize_Control_Multiselect extends WP_Customize_Control {
		...
		// Processing
			...
			// Scripts
				...
				if ( 'multicheckbox' === $this->type ) {
					...
					wp_enqueue_script(
							'icelander-customize-control-multicheckbox',
							get_theme_file_uri( ICELANDER_LIBRARY_DIR . 'js/customize-control-multicheckbox.js' ),
	...
	public function render_content_select() {
		...
		// Output
			...
			<label>
				...
				<em><?php esc_html_e( 'Press CTRL key for multiple selection.', 'icelander' ); ?></em>
			</label>
...
} // /Icelander_Customize_Control_Multiselect
