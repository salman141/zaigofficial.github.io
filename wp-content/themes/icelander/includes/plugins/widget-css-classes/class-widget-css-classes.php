 ...
 * 10) Functionality
 */
class Icelander_Widget_CSS_Classes {
	 ...
	 */
		 ...
		 * Constructor
		 *
		 * @uses  `wmhook_icelander_widget_css_classes` global hook
		 *
		 * @since    1.0.0
		 * @version  1.0.0
		 */
		private function __construct() {
			...
			// Helper variables
				...
				self::$classes = (array) apply_filters( 'wmhook_icelander_widget_css_classes', array() );
		...
		public static function widget_css_classes( $settings = array() ) {
			...
			// Processing
				...
				// Make predefined theme classes visible
					...
					if ( apply_filters( 'wmhook_icelander_widget_css_classes_force_type', true ) ) {
						$settings['type'] = 3;
					}
...
} // /Icelander_Widget_CSS_Classes

add_action( 'after_setup_theme', 'Icelander_Widget_CSS_Classes::init' );
