 ...
 * 100) Others
 */
class Icelander_WooCommerce_Wrappers {
	 ...
	 */
		...
		public static function template_part_wrapper_open( $template_name ) {
			...
			// Pre
				...
				$pre = apply_filters( 'wmhook_icelander_woocommerce_wrappers_template_part_wrapper_open_pre', false, $template_name );
		...
		public static function template_part_wrapper_close( $template_name ) {
			...
			// Pre
				...
				$pre = apply_filters( 'wmhook_icelander_woocommerce_wrappers_template_part_wrapper_close_pre', false, $template_name );
...
} // /Icelander_WooCommerce_Wrappers

add_action( 'after_setup_theme', 'Icelander_WooCommerce_Wrappers::init' );
