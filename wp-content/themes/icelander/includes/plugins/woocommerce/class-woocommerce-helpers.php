 ...
 * 20) Product
 */
class Icelander_WooCommerce_Helpers {
	 ...
	 */
		...
		public static function return_number( $context = '' ) {
			...
			// Processing
				...
				$output = (array) apply_filters( 'wmhook_icelander_woocommerce_helpers_return_number', $output, $context );
