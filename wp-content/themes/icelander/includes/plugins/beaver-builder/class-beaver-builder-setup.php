 ...
 * 100) Others
 */
class Icelander_Beaver_Builder_Setup {
	 ...
	 */
		...
		public static function get_theme_colors() {
			...
			// Requirements check
				...
				$theme_colors = get_transient( 'icelander_theme_colors' );
			...
			// Processing
				...
				// Cache the colors
					...
					set_transient( 'icelander_theme_colors', $theme_colors );
		...
		public static function theme_colors_cache_flush() {
			...
			// Processing
				...
				delete_transient( 'icelander_theme_colors' );
...
} // /Icelander_Beaver_Builder_Setup

add_action( 'after_setup_theme', 'Icelander_Beaver_Builder_Setup::init' );
