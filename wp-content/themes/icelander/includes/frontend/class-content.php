	 ...
	 */
		...
		public static function headings_level_up( $html ) {
			...
			// Pre
				...
				$pre = apply_filters( 'wmhook_icelander_content_headings_level_up_pre', false, $html );
...
add_action( 'after_setup_theme', 'Icelander_Content::init' );
