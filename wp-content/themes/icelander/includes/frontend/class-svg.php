	 ...
	 */
		...
		public static function get( $args = array() ) {
			...
			// Variables
				...
				$args = (array) apply_filters( 'wmhook_icelander_svg_get_args', $args );
				 ...
				 *
				 * Example 1 with title: <?php echo Icelander_SVG::get( array( 'icon' => 'arrow-right', 'title' => __( 'This is the title', 'textdomain' ) ) ); ?>
				 *
				 * Example 2 with title and description: <?php echo Icelander_SVG::get( array( 'icon' => 'arrow-right', 'title' => __( 'This is the title', 'textdomain' ), 'desc' => __( 'This is the description', 'textdomain' ) ) ); ?>
				 *
			...
			// Processing
				...
				$output = (array) apply_filters( 'wmhook_icelander_svg_get_output', $output, $args );
	 ...
	 */
		...
		public static function get_social_icons() {
			...
			// Output
				...
				return (array) apply_filters( 'wmhook_icelander_svg_get_social_icons', array() );
...
add_action( 'after_setup_theme', 'Icelander_SVG::init' );
