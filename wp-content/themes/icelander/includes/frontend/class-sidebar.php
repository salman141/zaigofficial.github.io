			...
			// Processing
				...
				// Hooks
					...
					// Actions
						...
						add_action( 'wmhook_icelander_intro_after', __CLASS__ . '::intro' );
					...
					// Filters
						...
						add_filter( 'wmhook_icelander_header_body_classes_sidebars', __CLASS__ . '::body_class_sidebars' );
		...
		public static function register() {
			...
			// Helper variables
				...
				$widget_areas = array(
					...
					'sidebar' => array(
						'name'        => esc_html__( 'Sidebar', 'icelander' ),
						'description' => esc_html__( 'Default sidebar area.', 'icelander' ),
					),

					'header' => array(
						'name'        => esc_html__( 'Header Widgets', 'icelander' ),
						'description' => esc_html__( 'Widgetized area displayed in website header.', 'icelander' ),
					),

					'intro' => array(
						'name'        => esc_html__( 'Intro Widgets', 'icelander' ),
						'description' => esc_html__( 'Widgetized area displayed at the bottom of the Intro title section.', 'icelander' ),
					),

					'footer' => array(
						'name'        => esc_html__( 'Footer Widgets', 'icelander' ),
						'description' => esc_html__( 'Widgetized area displaying the main website footer content.', 'icelander' ),
					),

					'footer-secondary' => array(
						'name'        => esc_html__( 'Footer Secondary Widgets', 'icelander' ),
						'description' => esc_html__( 'Additional widgetized area displayed in the website footer.', 'icelander' ),
					),
		...
		public static function secondary_conditions( $is_active_sidebar, $index ) {
			...
			// Processing
				...
				if (
						...
						|| Icelander_Post::is_page_builder_ready()
						|| apply_filters( 'wmhook_icelander_sidebar_disable', false )
					) {
...
add_action( 'after_setup_theme', 'Icelander_Sidebar::init' );
