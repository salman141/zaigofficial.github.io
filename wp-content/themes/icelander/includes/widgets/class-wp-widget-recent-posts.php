 ...
 */
	 ...
	 * 20) Options
	 */
	class Icelander_WP_Widget_Recent_Posts extends WP_Widget_Recent_Posts {
			...
			public function widget( $args, $instance ) {
				...
				// Helper variables
					...
					if ( empty( $instance['title'] ) ) {
						$instance['title'] = esc_html__( 'Recent Posts', 'icelander' );
					}
				...
				// Processing
					...
					do_action( 'wmhook_icelander_widget_recent_posts_before', $args, $instance );
				...
				// Output
					...
					do_action( 'wmhook_icelander_widget_recent_posts_after', $args, $instance );
				...
				// Output
					...
					<p>
						<label for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>">
							<?php esc_html_e( 'From category:', 'icelander' ); ?>
						</label>
						<?php
	...
	} // /Icelander_WP_Widget_Recent_Posts
	 ...
	 * @version  1.0.0
	 */
	function icelander_register_widget_recent_posts() {

		// Processing

			unregister_widget( 'WP_Widget_Recent_Posts' );

			register_widget( 'Icelander_WP_Widget_Recent_Posts' );

	} // /icelander_register_widget_recent_posts

	add_action( 'widgets_init', 'icelander_register_widget_recent_posts' );
