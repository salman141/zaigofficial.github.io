...
class valen_Megamenu_Admin extends Walker_Nav_Menu  {
	        ...
	        <dl class="menu-item-bar">
	            <dt class="menu-item-handle">
	                <span class="item-title">
	                	...
	                	<span class="is-submenu" <?php if($depth == 0) echo 'style="display:none"'; ?>><?php echo esc_html__('sub item', 'valen'); ?></span>
	                <span class="item-controls">
	                    ...
	                    <span class="item-order hide-if-js">
	                        ...
	                        ?>" class="item-move-up"><abbr title="<?php esc_attr_e('Move up', 'valen'); ?>">&#8593;</abbr></a>
	                        |
	                        <a href="<?php
	                            echo  esc_url(
										wp_nonce_url(
	                        ...
	                        ?>" class="item-move-down"><abbr title="<?php esc_attr_e('Move down', 'valen'); ?>">&#8595;</abbr></a>
	                    </span>
	                    <a class="item-edit" id="edit-<?php echo esc_attr($item_id); ?>" title="<?php esc_attr_e('Edit Menu Item', 'valen'); ?>" href="<?php
	                    ...
	                    ?>"><?php esc_html_e( 'Edit Menu Item', 'valen' ); ?></a>
	                </span>
	            </dt>
	        </dl>
	        ...
	        <div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo esc_attr($item_id); ?>">
	            ...
	            <p class="description description-thin">
	                <label for="edit-menu-item-title-<?php echo esc_attr($item_id); ?>">
	                    <?php esc_html_e( 'Navigation Label', 'valen' ); ?><br />
	                    <input type="text" id="edit-menu-item-title-<?php echo esc_attr($item_id); ?>" class="widefat edit-menu-item-title" name="menu-item-title[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr( $item->title ); ?>" />
	                </label>
	            </p>
	            <p class="description description-thin">
	                <label for="edit-menu-item-attr-title-<?php echo esc_attr($item_id); ?>">
	                    <?php esc_html_e( 'Title Attribute', 'valen' ); ?><br />
	            ...
	            <p class="field-link-target description">
	                <label for="edit-menu-item-target-<?php echo esc_attr($item_id); ?>">
	                    ...
	                    <?php esc_html_e( 'Open link in a new window/tab', 'valen' ); ?>
	                </label>
	            </p>
	            <p class="field-css-classes description description-thin">
	                <label for="edit-menu-item-classes-<?php echo esc_attr($item_id); ?>">
	                    <?php esc_html_e( 'CSS Classes (optional)', 'valen' ); ?><br />
	                    <input type="text" id="edit-menu-item-classes-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-classes" name="menu-item-classes[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr( implode(' ', $item->classes ) ); ?>" />
	                </label>
	            </p>
	            <p class="field-xfn description description-thin">
	                <label for="edit-menu-item-xfn-<?php echo esc_attr($item_id); ?>">
	                    <?php esc_html_e( 'Link Relationship (XFN)', 'valen' ); ?><br />
	                    <input type="text" id="edit-menu-item-xfn-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-xfn" name="menu-item-xfn[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr( $item->xfn ); ?>" />
	                </label>
	            </p>
	            <p class="field-description description description-wide">
	                <label for="edit-menu-item-description-<?php echo esc_attr($item_id); ?>">
	                    <?php esc_html_e( 'Description', 'valen' ); ?><br />
	                    ...
	                    <span class="description"><?php esc_html_e('The description will be displayed in the menu if the current theme supports it.', 'valen'); ?></span>
	                </label>
	            </p>        
	            <!-- Begin: Option Megamenu -->
               	...
               	<p class="field-megamenu-useicon description description-wide">
	                <label for="sns-mega-mitem-useicon-<?php echo esc_attr($item_id); ?>">
						<span class="sns-desc"><?php esc_html_e( 'Use Icon?', 'valen' ); ?></span><br/>
						<select id="sns-mega-mitem-useicon-<?php echo esc_attr($item_id); ?>" class="edit-menu-item-menu-useicon" name="sns-mega-mitem-useicon[<?php echo esc_attr($item_id); ?>]">
								<option value="" <?php selected($item->useicon, '', true);?>><?php esc_html_e( 'No', 'valen' ); ?></option>
								<option value="font" <?php selected($item->useicon, 'font', true);?>><?php esc_html_e( 'Icon Font', 'valen' ); ?></option>
								<option value="image" <?php selected($item->useicon, 'image', true);?>><?php esc_html_e( 'Icon Image', 'valen' ); ?></option>
						</select>
					</label>
	            </p>
	           	<p class="field-megamenu-icon description description-wide">
	                <label for="edit-menu-item-icon-<?php echo esc_attr($item_id); ?>">
	                    <span class="sns-desc"><?php esc_html_e( "Menu Item's Icon", 'valen' ); ?></span><br/>
	                    <?php 
	                    ...
	                    ?>
	                    <?php  ?>
                        <a data-pickerid="<?php echo esc_attr($item_id); ?>" class="button-primary sns-iconpicker" title="<?php echo esc_attr__('Select Icon','valen');?>" href="#" ><?php echo esc_html__('Select Icon','valen');?></a>
                        <?php  ?>
                        ...
                        <a class="button-primary sns-icon-mega-img" title="<?php echo esc_attr__('Select Image','valen');?>" href="#" ><?php echo esc_html__('Select Image','valen');?></a>
                        <a class="button-secondary sns-remove-icon-mega-img" title="<?php echo esc_attr__('Remove Icon','valen');?>" href="#" ><i class="fa fa-times"></i><?php echo esc_html__('Remove Icon','valen');?></a>

	                </label>
	            </p>
	            <p class="field-megamenu-enable description description-wide">
	                <label for="sns-mega-mitem-enable-<?php echo esc_attr($item_id); ?>">
	                    <?php esc_html_e( 'Enable Mega Menu(Apply for level 1)', 'valen' ); ?><br />
	            ...
	            <p class="field-megamenu-usepostwcode description description-wide">
	                <label for="sns-mega-mitem-usepostwcode-<?php echo esc_attr($item_id); ?>">
						<span>
							<?php esc_html_e( 'Use Post WCode for Mega Menu?', 'valen' ); ?>
						</span><br/>
						<select id="sns-mega-mitem-usepostwcode-<?php echo esc_attr($item_id); ?>" class="edit-menu-item-menu-usepostwcode" name="sns-mega-mitem-usepostwcode[<?php echo esc_attr($item_id); ?>]">
								<option value="" <?php selected($item->usepostwcodeemega, '', true);?>><?php esc_html_e( 'Select position to display...', 'valen' ); ?></option>
								<option value="left" <?php selected($item->usepostwcode, 'left', true);?>><?php esc_html_e( 'Show in left', 'valen' ); ?></option>
								<option value="right" <?php selected($item->usepostwcode, 'right', true);?>><?php esc_html_e( 'Show in right', 'valen' ); ?></option>
								<option value="bottom" <?php selected($item->usepostwcode, 'bottom', true);?>><?php esc_html_e( 'Show in bottom', 'valen' ); ?></option>
						</select>
					</label>
	            </p>
	            <p class="field-megamenu-postwcode description description-wide">
	                <label for="sns-mega-mitem-postwcode-<?php echo esc_attr($item_id); ?>">
						<span>
							<?php esc_html_e( 'Post WCode(Slug of Post WCode)', 'valen' ); ?>
						</span><br/>
	            ...
	            <p class="field-megamenu-background description description-wide">
	                <label for="sns-mega-mitem-background-<?php echo esc_attr($item_id); ?>">
						<span>
							<?php esc_html_e( 'Background Image for dropdown content', 'valen' ); ?>
						</span><br/>
						<?php
                        ...
                        <a class="button-primary sns-background-mega-img" title="<?php echo esc_attr__('Select Background','valen');?>" href="#" ><?php echo esc_html__('Select Background','valen');?></a>
                        <a class="button-primary sns-remove-background-mega-img" title="<?php echo esc_attr__('Remove Background','valen');?>" href="#" ><?php echo esc_html__('Remove Background','valen');?></a>
					</label>
	            </p>
	            <p class="field-megamenu-customcolumnstyle description description-wide">
	                <label for="sns-mega-mitem-customcolumnstyle-<?php echo esc_attr($item_id); ?>">
						<span>
							<?php esc_html_e( 'Custom style for dropdown content(Just apply for this element)', 'valen' ); ?>
						</span><br/>
                ...
                <p class="field-megamenu-hidetitle description description-wide">
	                <label for="sns-mega-mitem-hidetitle-<?php echo esc_attr($item_id); ?>">
	                    <?php esc_html_e( 'Hide Title(Apply for level 2 Mega Menu Columns Style)', 'valen' ); ?><br />
	            ...
	            <div class="menu-item-actions description-wide submitbox">
	                ...
	                echo esc_url(
						   wp_nonce_url( 
							  ...
							  ); ?>"><?php esc_html_e('Remove', 'valen'); ?></a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-<?php echo esc_attr($item_id); ?>" href="<?php echo esc_url( add_query_arg( array('edit-menu-item' => $item_id, 'cancel' => time()), remove_query_arg( $removed_args, admin_url( 'nav-menus.php' ) ) ) );
	                    ?>#menu-item-settings-<?php echo esc_attr($item_id); ?>"><?php esc_html_e('Cancel', 'valen'); ?></a>
	            </div>
