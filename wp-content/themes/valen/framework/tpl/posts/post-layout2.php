        ...
        <div class="part-left">
            <div class="gallery-thumb">
                ...
                foreach (rwmb_meta('valen_post_gallery', 'type=image') as $image) { ?>
                    <?php 
                    $src = $image['full_url'];
                    if ( $image['sizes']['valen_blog_list_thumb']['file'] ) {
                        $src = str_replace($image['name'], $image['sizes']['valen_blog_list_thumb']['file'], $image['full_url']);
                    }
                    ?>
    ...
    elseif ( has_post_thumbnail() ) : $post_media = true; ?>
        <div class="part-left">
            <div class="post-thumb">
                ...
                $img_size = 'valen_blog_list_thumb';
                ?>
