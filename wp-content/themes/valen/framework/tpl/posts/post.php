<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    ?>
        <div class="gallery-thumb">
            ...
            foreach (rwmb_meta('valen_post_gallery', 'type=image') as $image) { ?>
                <?php 
                $src = $image['full_url'];
                if ( $image['sizes']['valen_blog_default_thumb']['file'] ) {
                    $src = str_replace($image['name'], $image['sizes']['valen_blog_default_thumb']['file'], $image['full_url']);
                }
                ?>
    ...
    elseif ( has_post_thumbnail() ) : ?>
        <div class="post-thumb">
            ...
            $img_size = 'valen_blog_default_thumb';
            ?>
    ...
    <div class="post-meta">
            ...
            <?php if( 1 == 0 && ! is_single() && ! post_password_required() && ( comments_open() || get_comments_number() ) ): ?>
                ...
                <?php
                    ...
                    comments_popup_link( esc_html__( '0 Comments','valen' ),  esc_html__( '1 Comment','valen' ), '%' . esc_html__(' Comments','valen'));
                    echo '</span>';
                ?>
                </span>
            <?php endif; ?>
            ...
            <div class="post-excerpt">
                ...
                if ( is_search() ) {
                    ...
                    if( empty( $post->post_excerpt ) ) {
                        $readmore = '<span>'.esc_html__('Read More', 'valen').'</span><span class="meta-nav">&#8594;</span>';
                        ...
                        <p class="excerpt"><?php echo valen_excerpt( (int)valen_themeoption('excerpt_length', 75) ); ?></p>
                    <?php 
                    }
                } ?>
            </div>
