<?php
$author_bio_avatar_size = apply_filters('110', '110');
...
<div class="author-info">
	...
	<div class="author-description">
		...
		<h4 class="author-title">
			<?php printf( wp_kses(__( '%s <a class="author-link" href="%s" ref="author">%s</a>', 'valen' ), array(
										'a' => array(
											'href' => array(),
											'class' => array(),
											'ref' => array()
										),
										) ), esc_html__('Write by:', 'valen'), esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ),  get_the_author_meta('display_name') ); ?>
		</h4>
		<?php endif; ?>
