...
<div <?php post_class(); ?>>
	 ...
	 */
	add_action('valen_list_after_item_title', 'woocommerce_template_loop_price', 10);
	do_action( 'valen_list_after_item_title' );

	?>
				<?php
				if ( !empty($show_viewmore) && $show_viewmore == '1') :?>
					<a class="viewmore btn" href="<?php the_permalink(); ?>"><?php echo esc_html__('View More', 'valen'); ?></a>
				<?php endif; ?>
				</div>
			</div>
	</div>
