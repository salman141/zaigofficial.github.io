  ...
  <div class="has-2-columns is-wider-left" style="max-width: 100%">
    <div class="column">
      ...
      <div class="feature-section" style="margin: 15px 0;">
        ...
        <a style="background-color: #006cff;color: #ffffff;text-decoration: none;padding: 10px 30px;border-radius: 30px;margin: 10px 0 0 0;display: inline-block;" target="_blank" href="<?php echo QLTTF_DEMO_URL; ?>"><?php esc_html_e('View demo', 'wp-tiktok-feed'); ?></a>
      </div>
      <div class="feature-section" style="margin: 15px 0;">
