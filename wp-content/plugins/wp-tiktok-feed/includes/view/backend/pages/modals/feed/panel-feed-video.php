<div id="tab_panel_feed_video" class="panel qlttf_options_panel <# if (data.panel != 'tab_panel_feed_video') { #>hidden<# } #>">
  ...
  <div class="options_group">
    ...
    <p class="form-field">
      ...
      <input name="video[controls]" type="checkbox" value="true" <# if (data.video.controls){ #>checked<# } #>/>
    ...
    <p class="form-field">
      ...
      <input name="video[autoplay]" type="checkbox" value="true" <# if (data.video.autoplay){ #>checked<# } #>/>
