...
<div class="landing">
	...
	<div class="section section-odd clear" style="background: #f1f1f1 url( <?php echo esc_url_raw( YITH_WCBM_ASSETS_URL . '/images/02-bg.png' ); ?> ) no-repeat 15% 100%">
		<div class="landing-container">
			<div class="col-2">
				<div class="section-title">
	...
	<div class="section section-odd clear" style="background: #f1f1f1 url( <?php echo esc_url_raw( YITH_WCBM_ASSETS_URL . '/images/04-bg.png' ); ?> ) no-repeat #f1f1f1 15% 100%">
		<div class="landing-container">
			<div class="col-2">
				<div class="section-title">
	...
	<div class="section section-odd clear" style="background: #f1f1f1 url( <?php echo esc_url_raw( YITH_WCBM_ASSETS_URL . '/images/07-bg.png' ); ?> ) no-repeat 15% 100%">
		<div class="landing-container">
			<div class="col-2">
				<div class="section-title">
	...
	<div class="section section-odd clear" style="background: #f1f1f1 url(<?php echo esc_url_raw( YITH_WCBM_ASSETS_URL . '/images/08-bg.png' ); ?>) no-repeat 15% 100%">
		<div class="landing-container">
			<div class="col-2">
				<div class="section-title">
	...
	<div class="section section-odd clear" style="background: #f1f1f1 url( <?php echo esc_url_raw( YITH_WCBM_ASSETS_URL . '/images/10-bg.png' ); ?> ) no-repeat 15% 100%">
		<div class="landing-container">
			<div class="col-2">
				<div class="section-title">
	...
	<div class="section section-odd clear" style="background: #f1f1f1 url( <?php echo esc_url_raw( YITH_WCBM_ASSETS_URL . '/images/12-bg.png' ); ?> ) no-repeat15% 100%">
		<div class="landing-container">
			<div class="col-2">
				<div class="section-title">
	...
	<div class="section section-odd clear" style="background: #f1f1f1 url(<?php echo esc_url_raw( YITH_WCBM_ASSETS_URL . '/images/14-bg.png' ); ?>) no-repeat 15% 100%">
		<div class="landing-container">
			<div class="col-2">
				<div class="section-title">
